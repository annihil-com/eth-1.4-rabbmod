...
void eth_CG_DrawActiveFrame(void) {
	...
	switch( (int)seth.value[VAR_KSPAM] ){
		...
		case KS3:
			...
			break;
		case KS4:
			strncpy(ksFormat, "[C] ^3[n]^7 ^g(kills: ^3[t]^g) [W] [R]",sizeof(ksFormat));
			break;
		case KS5:
			strncpy(ksFormat, "^1[n] ^3never liked ETH ^3[P]",sizeof(ksFormat));
			break;
		case KS6:
			strncpy(ksFormat, "^4[v] ^7was fragged![3][e]",sizeof(ksFormat));
			break;
		case KS7:
			strncpy(ksFormat, "^0[^3NEXUS^0] ^nowned ^1>^7[n]^1< ^0| ^nSpree: ^1[c] ^0| ^nTotal: ^1[t] ^3[m]",sizeof(ksFormat));
			break;
		case KS8:
			strncpy(ksFormat, "^GKillingsrpee: ^2[c] ^3:: ^2[n] ^3:: ^gWas killed^3!![R]",sizeof(ksFormat));
			break;
		case KS9:
			strncpy(ksFormat, "^2[v][9] ^7(kills: ^1[t]^7) [R]",sizeof(ksFormat));
			break;
		case KS10:
			strncpy(ksFormat, "^2[v] ^7was victim ^1[c] ^7on this spree",sizeof(ksFormat));
			break;
		case KS11:
			strncpy(ksFormat, "^1[n] ^x[6] ^3(kills: ^1[t]^3)",sizeof(ksFormat));
			break;
		case KS12:
			strncpy(ksFormat, "^1[n] ^3is Victim ^g[t] ^3Of The Day.[P]",sizeof(ksFormat));
			break;
		case KS13:
			strncpy(ksFormat, "^1[n] [8] ^7(kills: ^1[t]^7)",sizeof(ksFormat));
			break;
		case KS14:
